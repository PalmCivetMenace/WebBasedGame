...
if ( app ) {
   isApp=true;
document.write(cordova.plugin);	
permissions = cordova.plugins.permissions;
document.write("LOL_2");
} else {
isApp=false;
}  
//-------------------INTERNET PERMISSION
...
unset_email=email;
unset_psswd=psswd;
ajaxPOST("http://chamathinfotech.000webhostapp.com/Gallus%20by%20Abstract/www/php/LoginPlayer.php",_Login,data);
...
function LogOut(){
ajaxGET("http://chamathinfotech.000webhostapp.com/Gallus%20by%20Abstract/www/php/Logout.php",_errorHandle);
...
ajaxPOST("http://chamathinfotech.000webhostapp.com/Gallus%20by%20Abstract/www/php/newPlayer.php",_errorHandle,data);
}
//--------------------------Change Password
function showForgot(){
...
ajaxPOST("http://chamathinfotech.000webhostapp.com/Gallus%20by%20Abstract/www/php/newToken.php",_errorHandle,data);
}
...
ajaxGET("http://chamathinfotech.000webhostapp.com/Gallus%20by%20Abstract/www/php/getVal.php?email="+player.email+"&val=saying",_getSaying);
}
...
link="http://chamathinfotech.000webhostapp.com/Gallus%20by%20Abstract/www/php/ChangeSay.php?email="+player.email+"&saying="+newSaying;
...
if(checkInternetPerm())
{
ajaxGET("http://chamathinfotech.000webhostapp.com/Gallus%20by%20Abstract/www/php/ks.php",_showKingMsg);
}
}
...
function isNewKing(){
ajaxGET("http://chamathinfotech.000webhostapp.com/Gallus%20by%20Abstract/www/php/Highest.php",_isNewKing);
}
...
ajaxGET("http://chamathinfotech.000webhostapp.com/Gallus%20by%20Abstract/www/php/newHigh.php?email="+player.email+"&Score="+Score,newKing);
}
